...
class Profile extends Component {
    ...
    componentWillMount() {
        ...
        xhr.open("GET", this.props.baseUrl + "?access_token=2ac7b313d7b4ca244d1460b3a177fa6e");
        xhr.send(ownerData);
        ...
        xhrMediaData.open("GET", this.props.baseUrl + "media/recent/?access_token=2ac7b313d7b4ca244d1460b3a177fa6e");
